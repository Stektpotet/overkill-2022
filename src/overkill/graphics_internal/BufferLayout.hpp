...
//		return mStride;
//	}
//	void add(BufferElement element, size_t count = 1)
//	{
//		mElements.insert(mElements.end(), count, element);
//		mStride += element.size()
//	}
//	void add(std::initializer_list<BufferElement> elements, size_t count = 1)
//	{
//		mElements.reserve(mElements.size() + elements.size() * count);
//		for (size_t i = 0; i < count; i++)
//		{
//			mElements.insert(mElements.end(), elements.begin(), elements.end());
//			for (size_t j = 0; j < elements.size(); j++)
//				mStride += elements.size();
//		}
//	}
//	void add(BlockLayout block, size_t count = 1)
//	{
//		mElements.reserve(mElements.size() + block.mElements.size() * count);
//		for (size_t i = 0; i < count; i++)
//		{
//			mElements.insert(mElements.end(), block.mElements.begin(), block.mElements.end());
//			mStride += block.size();
//		}
//			
//	}
